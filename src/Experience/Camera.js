...
export default class Camera {
    ...
    setModes() {
        ...
        this.modes.debug.instance.position.set(8, 6, 8)
        ...
        this.modes.debug.orbitControls.maxPolarAngle = Math.PI / 2
        this.modes.debug.orbitControls.minAzimuthAngle = 0
        this.modes.debug.orbitControls.maxAzimuthAngle = Math.PI / 2
